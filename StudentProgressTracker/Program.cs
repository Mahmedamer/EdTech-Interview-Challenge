...
logger.LogInformation("Swagger UI available at: {BaseUrl}", app.Environment.IsDevelopment() ? "https://localhost:7000" : "Application root");
logger.LogInformation("Rate Limit Management: {BaseUrl}/api/v1.0/ratelimit/configuration", app.Environment.IsDevelopment() ? "https://localhost:7000" : "Application root");
